<x-app-layout>
    <div class="">
        {{-- header image --}}
        <div class="relative h-[calc(100vh-4rem)] border-solid border-2 border-red-600 p-6">
            {{-- upper row --}}
            <div class="border-solid border-2 border-blue-600 h-1/3 flex justify-between items-center gap-2 mb-2">
                <div class="border-solid border-2 border-red-600 h-full w-2/3"></div>
                <div class="border-solid border-2 border-red-600 h-full w-1/3"></div>
            </div>
            {{-- middle row --}}
            <div class="border-solid border-2 border-blue-600 h-1/3 flex justify-between items-center gap-2 mb-2">
                <div class="border-solid border-2 border-red-600 h-full w-1/4"></div>
                <div class="border-solid border-2 border-red-600 h-full w-1/4"></div>
                <div class="border-solid border-2 border-red-600 h-full w-1/4"></div>
                <div class="border-solid border-2 border-red-600 h-full w-1/4"></div>
            </div>
            {{-- bottom row --}}
            <div class="border-solid border-2 border-blue-600 h-1/3 flex justify-between items-center gap-2">
                <div class="border-solid border-2 border-red-600 h-full w-1/3"></div>
                <div class="border-solid border-2 border-red-600 h-full w-2/3"></div>
            </div>
        </div>
